...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxStartupLibraryAccessors extends SubDependencyFactory {
        ...
        public AndroidxStartupLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getRuntime() { return create("androidx.startup.runtime"); }
    ...
    public static class AndroidxVersionAccessors extends VersionFactory  {
        ...
        private final AndroidxStartupVersionAccessors vaccForAndroidxStartupVersionAccessors = new AndroidxStartupVersionAccessors(providers, config);
        ...
        /**
         * Returns the group of versions at versions.androidx.startup
         */
        public AndroidxStartupVersionAccessors getStartup() { return vaccForAndroidxStartupVersionAccessors; }
    ...
    public static class AndroidxNavigationVersionAccessors extends VersionFactory  {
        ...
        private final AndroidxNavigationRuntimeVersionAccessors vaccForAndroidxNavigationRuntimeVersionAccessors = new AndroidxNavigationRuntimeVersionAccessors(providers, config);
        public AndroidxNavigationVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Returns the group of versions at versions.androidx.navigation.runtime
         */
        public AndroidxNavigationRuntimeVersionAccessors getRuntime() { return vaccForAndroidxNavigationRuntimeVersionAccessors; }

    }

    public static class AndroidxNavigationRuntimeVersionAccessors extends VersionFactory  {

        public AndroidxNavigationRuntimeVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Returns the version associated to this alias: androidx.navigation.runtime.ktx (2.7.4)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getKtx() { return getVersion("androidx.navigation.runtime.ktx"); }

    }

    public static class AndroidxStartupVersionAccessors extends VersionFactory  {

        public AndroidxStartupVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Returns the version associated to this alias: androidx.startup.runtime (1.1.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getRuntime() { return getVersion("androidx.startup.runtime"); }
    ...
    public static class GoogleVersionAccessors extends VersionFactory  {
        ...
        public GoogleVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: google.ksp (1.9.10-1.0.13)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class KoinVersionAccessors extends VersionFactory  {
        ...
        public KoinVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: koin.android (3.4.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class KotlinVersionAccessors extends VersionFactory  {
        ...
        public KotlinVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: kotlin.android (1.9.10)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class RetrofitVersionAccessors extends VersionFactory  {
         ...
         */
        public RetrofitConverterVersionAccessors getConverter() { return vaccForRetrofitConverterVersionAccessors; }
    ...
    public static class RetrofitConverterVersionAccessors extends VersionFactory  {
        ...
        public RetrofitConverterVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: retrofit.converter.moshi (2.9.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getMoshi() { return getVersion("retrofit.converter.moshi"); }
